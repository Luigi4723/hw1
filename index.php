...
// Carico tutti i prodotti in un array
...
// Divido i prodotti a metà
$meta = ceil(count($prodotti) / 2);
$prima_meta = array_slice($prodotti, 0, $meta);
$seconda_meta = array_slice($prodotti, $meta);
?>
...
<head>
    ...
    <script src="carrello-contatore.js" defer></script>
...
<body>
    <header>
        ...
        <section class="header">
            ...
            <div class="header-right">
                ...
                <div class="mobile-menu" id="mobileMenu">
                    ...
                    <div class="menu-item">
                        <a href="categoria.php?categoria=Proteine" class="title">Proteine</a>
                    ...
                    <div class="menu-item">
                        <a href="categoria.php?categoria=Nutrizione" class="title">Nutrizione</a>
                    ...
                    <div class="menu-item">
                        <a href="categoria.php?categoria=Vitamine" class="title">Vitamine</a>
                    ...
                    <div class="menu-item">
                        <a href="categoria.php?categoria=Activewear" class="title">Activewear</a>
                    ...
                    <div class="menu-item">
                        <a href="categoria.php?categoria=SnackDrink" class="title">Snack & Drink</a>
                    ...
                    <div class="menu-item">
                        <a href="categoria.php?categoria=Alimentazione%20vegana" class="title">Alimentazione vegana</a>
                    ...
                    <div class="menu-item">
                        <a href="categoria.php?categoria=Performance" class="title">Performance</a>
                    ...
                    <div class="menu-item">
                        <a href="categoria.php?categoria=Gestione%20del%20peso" class="title">Gestione del peso</a>
                    ...
                    <div class="login-content">
                        <div class="auth-section">
                            <?php if ($is_logged): ?>
                                ...
                                <a href="logout.php" class="login-bt">Logout</a>
                            <?php else: ?>
                ...
                <a href="carrello.php" class="cart-link">
                    ...
                    <span id="carrello-contatore">0</span>
                </a>
        ...
        <nav class="navbar">
            <div class="nav-menu">
                <a href="categoria.php?categoria=Proteine">Proteine</a>
                <a href="categoria.php?categoria=Nutrizione">Nutrizione</a>
                <a href="categoria.php?categoria=Activewear">Activewear</a>
                <a href="categoria.php?categoria=SnackDrink">Snack & Drink</a>
                <a href="categoria.php?categoria=Alimentazione%20vegana">Alimentazione Vegana</a>
                <a href="categoria.php?categoria=Performance">Performance</a>
                <a href="categoria.php?categoria=Gestione%20del%20peso">Gestione del Peso</a> 
            </div>   
        </nav> 
    ...
    <section class="products">
            <?php foreach ($prima_meta as $prodotto): ?>
                <div class="product">
                    <img src="<?= htmlspecialchars($prodotto['immagine']) ?>" alt="<?= htmlspecialchars($prodotto['nome']) ?>">
                    <h2><?= htmlspecialchars($prodotto['nome']) ?></h2>
                    <p class="price" data-eur="<?= htmlspecialchars($prodotto['prezzo']) ?>">€<?= number_format($prodotto['prezzo'], 2) ?></p>

                    <a href="#" class="btn-acquista" data-id="<?= $prodotto['id'] ?>">Acquista</a>
                </div>
            <?php endforeach; ?>
            ...
            <?php foreach ($seconda_meta as $prodotto): ?>
                <div class="product">
                    <img src="<?= htmlspecialchars($prodotto['immagine']) ?>" alt="<?= htmlspecialchars($prodotto['nome']) ?>">
                    <h2><?= htmlspecialchars($prodotto['nome']) ?></h2>
                    <p class="price" data-eur="<?= htmlspecialchars($prodotto['prezzo']) ?>">€<?= number_format($prodotto['prezzo'], 2) ?></p>
        ...
        <div class="popup-container">
            ...
            <h2 id="popup-nome">Nome Prodotto</h2>
            <p class="popup-prezzo">€<span id="popup-prezzo">0.00</span></p>
            <input type="number" id="popup-quantita" value="1" min="1">
            <button class="btn-aggiungi-carrello" data-id="">🛒 AGGIUNGI AL CARRELLO</button>


            <div class="popup-desc-toggle">
                <span>Descrizione</span>
                <span id="desc-toggle">&#x25BC;</span>
            </div>
            <div id="popup-desc" class="popup-desc">Descrizione del prodotto...</div>
            </div>
        </div>
        </div>

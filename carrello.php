...
if (isset($_SESSION['username'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "
            SELECT p.nome, p.descrizione, p.immagine, p.prezzo, c.quantita
            FROM carrelli c
...
<body>
    ...
    <div>
        <h1 class= "mycart">Il tuo Carrello</h1>
    </div>

    <section id="carrello" class="products"> </section>



    <div class="carrello-riepilogo">
        <h2 id="totale-carrello">Totale: €<?= number_format($totale, 2) ?></h2>
        <button class="btn-checkout" onclick="window.location.href='checkout.php'">Procedi all'ordine</button>
    </div> 

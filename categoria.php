...
// Prendi la categoria dalla URL
$categoria = $_GET['categoria'] ?? '';

if (empty($categoria)) {
    header("Location: index.php"); // Se non c'è categoria, torna alla home
    exit();
}

// Prendi tutti i prodotti con quella categoria
...
<html lang="it">
  ...
  <body>
    ...
    <h1 id="titolo-categoria">Categoria: <?php echo htmlspecialchars($categoria); ?></h1>
  ...
  <section class="products">
    <?php while ($row = $result->fetch_assoc()): ?>
        <div class="product">
            ...
            <p class="price" data-eur="<?= htmlspecialchars($row['prezzo']) ?>">€<?= number_format($row['prezzo'], 2) ?></p>

            <a href="#" class="btn-acquista" data-id="<?= $row['id'] ?>">Acquista</a>
        </div>
    <?php endwhile; ?>
  </section>

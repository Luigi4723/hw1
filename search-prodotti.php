...
$prodotti = [];
if ($query !== '') {
    $sql = "SELECT id, nome, immagine, prezzo FROM prodotti WHERE LOWER(nome) LIKE ?";
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;700;900&family=Montserrat:wght@400;700;900&display=swap" rel="stylesheet">
     <title>Risultati ricerca: <?= htmlspecialchars($query) ?></title>
...
<body>
    ...
    <h1 id="titolo-categoria">Risultati per: <?= htmlspecialchars($query) ?></h1>
